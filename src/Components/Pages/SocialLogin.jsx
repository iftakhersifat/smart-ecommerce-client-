        ...
        <div className="w-full mt-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <button onClick={handleGoogle} type="button"
                    className="btn bg-white text-black border-[#e5e5e5] hover:bg-slate-50 normal-case rounded-2xl shadow-sm">
                ...
                <button onClick={handleGithub} type="button"
                    className="btn bg-black text-white border-black hover:bg-zinc-900 normal-case rounded-2xl shadow-sm">
