...
const SocialRegister = ({from}) => {
    ...
    const handleGithub = () => {
        registerWithGithub()
            .then(result => {
                console.log(result);
                toast.success("Successfully Registered with GitHub!", { duration: 3000 });
                navigate(from);
            })
...
<button type="button" onClick={handleGithub} className="mt-4 btn bg-black text-white border-black w-full">
