...
const AboutUs = () => {
  const teamMembers = [
    ...
    { name: "Mehedi Hasan Miraj", role: "Head of Supply Chain", img: "https://img.daisyui.com/images/profile/demo/spiderperson@192.webp" },
    { name: "Jaowad Mahir", role: "Chief Technology Officer", img: "https://img.daisyui.com/images/profile/demo/spiderperson@192.webp" },
    { name: "Minhaz Uddin", role: "Customer Experience Lead", img: "https://img.daisyui.com/images/profile/demo/spiderperson@192.webp" }
  ];
        ...
        <div className="max-w-6xl mx-auto px-6 md:px-6 lg:px-0 relative z-10">
          <div className="flex flex-col gap-6">
            ...
            <h1 className="text-6xl md:text-8xl font-black tracking-tighter leading-[0.85] mb-6">
              Simple. Smart.<br /> 
              <span className="text-indigo-600">Authentic. </span>
            </h1>
      ...
      <div className="max-w-6xl mx-auto px-6 md:px-6 lg:px-0  -mt-32 relative z-20">
        ...
        <section className="pb-32">
          <div className="flex flex-col md:flex-row justify-between items-end mb-24 border-b border-slate-100 dark:border-white/10 pb-12">
              ...
              <p className="text-slate-400 mt-6 font-medium max-w-[300px] text-right text-sm">Our diverse team of retail experts, engineers, and designers working for you.</p>
          </div>
        ...
        <section className="text-center bg-indigo-600 rounded-[4rem] py-24 px-6 text-white overflow-hidden relative group">
            <div className="relative z-10 space-y-8">
                ...
                <div className="flex flex-wrap justify-center gap-6">
                    <Link to='/products-list'className="px-12 py-5 bg-white text-indigo-600 font-black rounded-2xl hover:scale-105 transition-transform uppercase text-[10px] tracking-[0.3em] flex items-center gap-2">
                        <FaCartShopping /> Back to Shop</Link>
                    <Link to='/contact' className="px-12 py-5 bg-transparent border border-white/30 text-white font-black rounded-2xl hover:bg-white/10 transition-all uppercase text-[10px] tracking-[0.3em] flex items-center gap-3">
